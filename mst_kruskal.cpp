...
int main()  {
    int V =0, E = 0, i, N, u, v, cost;

    // Build the Graph ,Assuming vertices are labeled 0...V-1

    scanf("vertices  %d", &V); // Enter the number of vertices and edges (Vertices - 1)
        printf("Edges in MST %d :\n",E);

    scanf("edges (v-1) %d", &E); // Enter the number of vertices and edges (Vertices - 1)

    Edge **edges = new Edge*[E];
    printf("vertices in MST %d :\n",V);
